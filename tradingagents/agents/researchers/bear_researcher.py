...
Avoid repeating the same thesis in multiple phrasings. Add at least one quantified or scenario-based argument when possible (for example: what happens if factor composite stays weak, or if data quality remains poor).
